...
<div class="container bg-light-gray">
    <div class="main-content">
        <div class="featured-content">
            <div class="row-fluid">
                <div class="span8 offset3">
                    <?php
         $dt = new DateTime('now', new DateTimeZone('IST'));
        ...
        if($result){
            ...
            $datatime = new DateTime($datatime1, new DateTimeZone('IST'));
            $dt = new DateTime($datatime1, new DateTimeZone('IST'));
          ...
          ?>
                    ...
                    <p class="hgad">1. Exam Starting Time: <strong>
                            <?php echo $fm->DateFormat($dt1);?></strong></p>
                    <p>2. Current Time: <strong>
                            <?php echo $fm->DateFormat($st);?></strong></p>
                    <p>3. Exam Will End: <strong>
                            <?php echo $fm->DateFormat($newtime);?></strong></p>
                    <p>4. Total Question: <strong>
                            <?php echo $value['totalExamShowQues']; ?></strong></p>
                    <?php
         ...
         ?>
          ...
          $se =  $ttime % 60;
         ?>
                    <p>5. Time For Exam: <strong>
                            <?php echo $mi." Minutes ".$se." Seconds"; ?></strong></p>

                    <h2>Some Rules : </h2>
                    <p class="hgad"><strong>1. If you reload your current url or go back to your previous questions,You will be suspended from completing the exam.</strong></p>
                    <p><strong>2. Once you start your exam,then go back to the exam starting page you will be suspended.</strong></p>
                </div>
            </div>
            <?php 
     $ecv='';
    ...
    $getque = $qs->getquestionbygroup($egid,$gtok,$tq);
     ...
     ?>
        ...
        elseif($st==$dt1 || $st>$dt1){ ?>
                    ...
                    <?php  } else{?>
                    <button class="btn btn-primary esb">Exam is Yet to Start</button></a>
                    <?php } ?>
                </div>
            </div>
        </div>
