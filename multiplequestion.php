        ...
        <div class="featured-content">
                    ...
                    <div class="span8 offset3">
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="form-group hgad" style="margin-top: 0px;">
                                ...
                                <textarea class="form-control" rows="5" name="mulqtitle" required="1" placeholder="Question"></textarea>
                            </div>
                            ...
                            <div class="form-group hgad">
                                ...
                                <input type="number" class="form-control adgrfs" name="mark" placeholder="Should Be a number" required="1">
                            </div>
          ...
          ?>
                                <tr class="info cta">
                                    ...
                                    <td>
                                        <?php echo $value['mulfiop']; ?>
                                    </td>
                                    <td>
                                        <?php echo $value['mulsiop']; ?>
                                    </td>
                                    <td>
                                        <?php echo $value['multhop']; ?>
                                    </td>
                                    <td>
                                        <?php echo $value['mulfoop']; ?>
                                    </td>
                                    <td>
                                        <?php echo $value['mulcs']; ?>
                                    </td>
