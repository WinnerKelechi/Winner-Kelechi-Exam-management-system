            ...
            <div class="featured-content">
                <div class="row-fluid">
                    <div class="addashmain">
                        ...
                        <?php
            if(!$msg)
              echo "<p style='color:mintcream;'><i>You Haven't Registered for any Course.Please Connect Now</i></p>";
            else{
            	$i=0;
            	while ($value = $msg->fetch_assoc()) {
            		$i++;
            	}
            	echo "<p><i>You Registered for ".$i." Course</i></p>";
            }
	      ?>
                        <span style="margin-left: 850px;">
                            <a href="userconnectgroup.php"><input type="submit" name="cg" value="Register Course" name=""></a>
                            <?php
    ...
    ?>
                <div class="row-fluid eachgr">
                    ...
                    <div class="span5">
                        ...
                        <p style="margin-top: -12px;">
                            <i><strong> Total Question: </strong><span style="color:mintcream">
                                    <?php echo $res['totalExamShowQues']; ?></span></i>
                            <i><strong> Per Question Time: </strong><span style="color:mintcream">
                                    <?php echo $res['eachQuestionTime'];?> seconds</span></i>
                        </p>
                        <p style="margin-top: -12px;">
                            <i><strong> Total Exam Time: </strong><span style="color:mintcream">
                                    <?php echo ($res['totalExamShowQues']*$res['eachQuestionTime']); ?> Seconds</span></i>
                        </p>
                        <?php
                 if($ck1=='f') {?>
