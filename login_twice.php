    ...
    <div class="container">
        ...
        <section class="main">
            <form class="form-1" action="#" method="POST">
                <p class="field">
                    <input type="text" name="useremail" placeholder="Username or email" required="1">
                ...
                <p class="submit">
                    <button type="submit" name="submit"><img src="img/arrow.jpg"></button>
                </p>
            </form>
        </section>
