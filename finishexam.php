...
<div class="container bg-light-gray">
    <div class="main-content">
            ...
            <div class="row-fluid">
                <div class="span11 offset1">
                    <div class="alert alert-success" style="font-size: 16px;">
                        <strong>Success!!</strong> <span>Your Exam Is Completed Successfully. Please Back To The Dashboard.</span>
                    </div>
		...
		<a href="userdashboard.php"><button class="btn btn-primary offset4 esb1">LEAVE!</button></a>
     </div>
   </div>
  </div>
 </div>
